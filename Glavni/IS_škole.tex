...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Ucenik/Student_calendar.png}
    \end{center}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.22]{../UI/Administrator/Admin_begin_page.png}
    \end{center}
\caption{Početna strana}
\end{figure}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.22]{../UI/Administrator/Korisnicki_nalozi_nastavnika.png}
    \end{center}
