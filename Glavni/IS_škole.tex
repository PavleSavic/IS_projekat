...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.225]{../UI/Ucenik/Student_subject_math.png}
    \end{center}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.225]{../UI/Ucenik/Student_subject_math_exam.png}
    \end{center}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.225]{../UI/Ucenik/Student_subject_math_class.png}
    \end{center}
\caption{Pregled ocena iz odabranog predmeta filtriranih po željenom kriterijumu}
\end{figure}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.225]{../UI/Ucenik/Student_subject_math_activity.png}
    \end{center}
\caption{Pregled ocena iz odabranog predmeta filtriranih po željenom kriterijumu}
\end{figure}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Ucenik/Student_form_activity.png}
    \end{center}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Ucenik/Student_form_activity chess.png}
    \end{center}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Ucenik/Student_form_activity folklore.png}
    \end{center}
\caption{Kratak opis vannastavne aktivnosti}
\end{figure}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Ucenik/Student_form_activity sport.png}
    \end{center}
\caption{Kratak opis vannastavne aktivnosti}
\end{figure}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Ucenik/Student_form_activity choir.png}
    \end{center}
\caption{Kratak opis vannastavne aktivnosti}
\end{figure}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Ucenik/Student_form_activity check.png}
    \end{center}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Ucenik/Student_form_activity check success.png}
    \end{center}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Ucenik/Student_classes.png}
    \end{center}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.225]{../UI/Ucenik/Student_calendar.png}
    \end{center}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.225]{../UI/Administrator/Admin_begin_page.png}
    \end{center}
\caption{Početna strana}
\end{figure}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_nastavnika.png}
    \end{center}
\caption{Pregled naloga nastavnika}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_novi_nastavnik.png}
    \end{center}
\caption{Kreiranje novog nastavnika}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_novi_nastavnik 2.png}
    \end{center}
\caption{Kreiranje novog nastavnika}
\end{figure}
...
\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_potvrda_nastavnik.png}
    \end{center}
\caption{Uspešno kreiranje novog nastavnika}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_nastavnika 2.png}
    \end{center}
\caption{Nalozi nastavnika nakon kreiranja novog}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_izmeni_nastavnika.png}
    \end{center}
\caption{Izmena podataka o nastavniku}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_izmeni_nastavnika_potvrda.png}
    \end{center}
\caption{Potvrda izmene podataka o nastavniku}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_potvrda_izmene_nastavnik 2.png}
    \end{center}
\caption{Uspešna izmena podataka o nastavniku}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_deaktiviraj_nastavnika_potvrda.png}
    \end{center}
\caption{Potvrda deaktivacije naloga nastavnika}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_deaktiviraj_nastavnika_potvrda_2.png}
    \end{center}
\caption{Uspešna deaktivacija naloga nastavnika}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_deaktiviraj_nastavnika_2.png}
    \end{center}
\caption{Nalozi nastavnika nakon deaktivacije}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_ucenika.png}
    \end{center}
\caption{Pregled naloga učenika}
\end{figure}


\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_novi_ucenik.png}
    \end{center}
\caption{Kreiranje novog učenika}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_potvrda_ucenik.png}
    \end{center}
\caption{Uspešno kreiranje novog učenika}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_izmeni_ucenika.png}
    \end{center}
\caption{Izmena podataka o učeniku}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_izmeni_ucenika_potvrda.png}
    \end{center}
\caption{Potvrda izmene podataka o učeniku}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_potvrda_izmene_ucenika_2.png}
    \end{center}
\caption{Uspešna izmena podataka o učeniku}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_deaktiviraj_ucenika_potvrda.png}
    \end{center}
\caption{Potvrda deaktivacije naloga učenika}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_deaktiviraj_ucenika_potvrda_2.png}
    \end{center}
\caption{Uspešna deaktivacija naloga učenika}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_ucenika_3.png}
    \end{center}
\caption{Nalozi učenika nakon deaktivacije}
\end{figure}

\begin{figure} [!ht]
    \begin{center}
        \includegraphics[scale=0.235]{../UI/Administrator/Korisnicki_nalozi_ucenika 2.png}
    \end{center}
\caption{Nalozi učenika nakon ponovne aktivacije}
\end{figure}
